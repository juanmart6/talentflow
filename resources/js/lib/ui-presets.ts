export const UI_PRESETS = {
    ...
    tabBase: 'h-9 min-w-[118px] justify-center rounded-b-none border border-b-0 px-3 cursor-pointer',
    tabActive: 'border-[#2563eb]/45 bg-white text-[#1d4ed8] shadow-sm hover:bg-white dark:bg-slate-950 dark:text-sky-300 dark:hover:bg-slate-950',
    tabInactive: 'border-transparent text-muted-foreground hover:border-[#2563eb]/30 hover:bg-[#2563eb]/8 hover:text-[#1d4ed8] dark:hover:border-[#2563eb]/40 dark:hover:bg-[#2563eb]/15 dark:hover:text-sky-300',
    tabDisabled: 'cursor-not-allowed border-transparent text-muted-foreground/60',
