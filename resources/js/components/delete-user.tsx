                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1 text-red-700 dark:text-red-100">
                            ...
                            <p className="text-sm">
                                No podrás iniciar sesión de nuevo hasta que un
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            ...
                            <DialogDescription>
                                Esta acción cerrará tu sesión y bloqueará
                                futuros inicios de sesión. Introduce tu
