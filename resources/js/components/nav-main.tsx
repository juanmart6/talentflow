...
export function NavMain({ items = [] }: { items: NavItem[] }) {
    ...
    return (
        <SidebarGroup className="px-1.5 py-1">
            <SidebarGroupLabel className="px-2.5 text-[11px] font-semibold tracking-[0.12em] uppercase text-sidebar-foreground/55">
                Navegación
            </SidebarGroupLabel>
